...
public interface IRoutineActionsStorage
{
    ...
    Task<WeekRoutineAction> GetAction(long userId, long sprintNumber, string actionId, int weekNumber);
    Task AddAction(long userId, long sprintNumber, int typeSprintNumber, RoutineAction weekRoutineAction);
